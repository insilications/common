...
def main():
    ...
    zap_line_in_file("b/options.conf", "keepstatic = true")
    ...
    zap_line_in_file("b/options.conf", "so_to_lib = true")
    ...
    zap_line_in_file("b/options.conf", "domain = ")
    zap_line_in_file("b/options.conf", "# alternative flags")
    zap_line_in_file("b/options.conf", "fsalt1 = true")
    zap_line_in_file("b/options.conf", "# alternative pgo flags")
    zap_line_in_file("b/options.conf", "altflags_pgo = false")
